...
function TaxiServiceChandigarh() {
  return (
    <div className="bg-gray-50 py-12 md:px-20">
      ...
      <section className="mb-12 px-2 md:px-20 text-center">
        ...
        <p className="mt-4 text-gray-700">
          We offer 24X7 airport taxi services so you dont have to worry about traveling to and from the airport. Enjoy a seamless travel experience with us!
        </p>
      </section>
...
export default TaxiServiceChandigarh;
